          ...
          {(mode === 'signin' || mode === 'signup') && (
            <form onSubmit={handleAuth} className="p-4 pt-4 space-y-4">
              ...
              <button
                ...
                disabled={loading}
                className="w-full h-11 rounded-2xl border-2 border-slate-200 bg-white/60 text-slate-700 font-bold text-sm active:scale-[0.98] hover:bg-slate-50 transition-all flex items-center justify-center gap-2 disabled:opacity-60"
              >
