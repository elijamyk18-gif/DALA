        ...
        >
          ...
          <div className="px-4 pb-5 text-center">
            <p className="text-xs text-slate-400">
              ...
              <button className="text-orange-500 font-semibold underline underline-offset-2">Terms</button>
              {' '}and{' '}
              <button className="text-orange-500 font-semibold underline underline-offset-2">Privacy Policy</button>
            </p>
          </div>
        </motion.div>
      </div>
